...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 19 jan. 2018 à 04:34
...
--
-- Déchargement des données de la table `action_demande`
--

INSERT INTO `action_demande` (`id`, `id_demande`, `id_utilisateur`, `email`, `date_action`, `id_etat`, `action`) VALUES
(99, 35, 3, 'supserviceit@gmail.com', '2018-01-19 04:29:26', 5, 'Refusee');
...
CREATE TABLE `demande` (
  ...
  `elements_associes` varchar(255) DEFAULT NULL,
  `type` varchar(50) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `file_url` varchar(255) DEFAULT NULL,
  `priorite_demande_it` varchar(60) DEFAULT NULL,
  `motif` varchar(255) DEFAULT NULL,
  `montant_total` double NOT NULL,
  `responsable_budget` varchar(60) NOT NULL,
  `bond_commande` varchar(255) DEFAULT NULL,
  `num_bond_achat` varchar(60) DEFAULT NULL,
  `bond_livraison` varchar(255) DEFAULT NULL,
  `centre` varchar(60) DEFAULT NULL,
  `satisfaction` varchar(60) DEFAULT NULL,
  `commentaire_satisfaction` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(5, 236756, 1, 'SETTI', 'HATIM', 'etu.mundia@gmail.com', 1);
...
(6, 7, 'achat', 'article1', 100, 700),
(10, 78, '', 'jhjh', 77, 6006),
(15, 78, 'TEST', 'TEST', 888, 69264),
(29, 89, 'njkhjl', 'hj', 8888, 791032),
(32, 77, 'HJkl', 'hjh', 777, 59829);
...
--
-- Déchargement des données de la table `ligne_equipement`
--

INSERT INTO `ligne_equipement` (`id`, `equipement`, `id_demande`) VALUES
(5, 'micophones', 19),
(6, 'fauteuils', 19),
(7, 'micophones', 20),
(8, 'rétroprojecteur', 20),
(9, 'fauteuils', 20),
(10, 'tables', 20),
(11, 'rétroprojecteur', 21),
(12, 'tables', 21),
(13, 'systeme de sonorisation', 31),
(14, 'tables', 31);
...
(6, 'ANAS', 'IT', 'serviceitmundia@gmail.com', 3, 10, 18),
(7, 'DOUNIA', 'BELOUALI', 's.scolaritem@gmail.com', 2, 15, 16),
(8, 'HAJIBA', 'KHALIDI', 's.recouvre@gmail.com', 1, 20, 16),
(11, 'IMANE', 'OUAKRIM', 's.achatlog@gmail.com', 8, 14, 16),
(12, 'CONTROLE', 'GESTION', 's.controlem@gmail.com', 9, 18, 16),
...
(17, 'PROFESSEUR', 'MUNDIA', 'prof.mundia@gmail.com', 6, 17, 16),
(18, 'IT', 'NABIL', 'supserviceit@gmail.com', 12, 20, 16);
